    ...
    stage('Tests de déploiement') {
      ...
      stages {
        ...
        stage('Téléchargement du binaire') {
          ...
          steps {
            sh "wget --user=admin --password='admin123'-P /home/jenkins/tomcat/webapps http://10.10.20.31:8081/repository/depot_test/rondoudou${BUILD_NUMBER}.war"
      ...
      stages {
        ...
        stage('Stockage de l\'image') {
          ...
          steps {
            ...
            sh 'docker login -u mahmoudmiha -p Respons11'
